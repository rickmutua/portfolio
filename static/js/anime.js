...
vertex3d.prototype = {
    ...
    var textSet = [
        {text:"HI", sphereRadius:140, sphereSpace:70, unitTime:150  , time:5000},
        {text:"I_AM", sphereRadius:100, sphereSpace:70, unitTime:150, time:5000},
        {text:"ERICK_MUTUA", sphereRadius:130, sphereSpace:90, unitTime:200, time:6000},
//        {text:"MUTUA", sphereRadius:120, sphereSpace:70, unitTime:50, time:4000},
//        {text:"A", sphereRadius:100, sphereSpace:30, unitTime:100, time:2000},
//        {text:"FULL_STACK", sphereRadius:130, sphereSpace:70, unitTime:100, time:5000},
//        {text:"WEB", sphereRadius:60 + Math.random()*60, sphereSpace:80, unitTime:100, time:4000},
//        {text:"DEVELOPER", sphereRadius:130, sphereSpace:80, unitTime:100, time:5000},
//        {text:"FROM", sphereRadius:130, sphereSpace:80, unitTime:100, time:3500},
//        {text:"NAIROBI", sphereRadius:120, sphereSpace:70, unitTime:50, time:4000},
//        {text:"KENYA", sphereRadius:100, sphereSpace:60, unitTime:100, time:3500},
//        {text:"HACK_ME!", sphereRadius:140, sphereSpace:80, unitTime:100, time:2500},
        {text:"@@@@@@@@", sphereRadius:60 + Math.random()*60, sphereSpace:100, unitTime:150, time:5000}
    ];
    ...
    var invertCV = new closeValue(500, 700);
    ...
    camera.rotate.x = e.pageY/window.innerHeight * 80 - 30;
    camera.rotate.y = e.pageX/window.innerWidth * 80 - 30;
